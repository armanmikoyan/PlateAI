...
export function readServerConfig(env: NodeJS.ProcessEnv = process.env): ServerConfig {
  ...
  return {
    ...
    LEMON_SQUEEZY_WEBHOOK_SECRET: requiredEnv('LEMON_SQUEEZY_WEBHOOK_SECRET', env.LEMON_SQUEEZY_WEBHOOK_SECRET),
    LEMON_SQUEEZY_STORE_ID: requiredEnv('LEMON_SQUEEZY_STORE_ID', env.LEMON_SQUEEZY_STORE_ID),
    LEMON_SQUEEZY_VARIANT_ID_PLUS: requiredEnv('LEMON_SQUEEZY_VARIANT_ID_PLUS', env.LEMON_SQUEEZY_VARIANT_ID_PLUS),
    LEMON_SQUEEZY_VARIANT_ID_PRO: requiredEnv('LEMON_SQUEEZY_VARIANT_ID_PRO', env.LEMON_SQUEEZY_VARIANT_ID_PRO),
